...
/*   Updated: 2025/02/19 17:41:11 by vkostand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(t_cub3D *data, t_move *move_cords)
{
	...
	if (y_map_cords < data->map.height_map_y && y_map_cords >= 0
		&& x_map_cords >= 0 && x_map_cords < data->map.width_map_x)
	{
		if (data->map.map2d[y_map_cords][x_map_cords] != '1'
			&& data->map.map2d[y_map_cords][data->player.ply_x
			/ TILE_SIZE] != '1' && data->map.map2d[data->player.ply_y
			/ TILE_SIZE][x_map_cords] != '1')
		{
